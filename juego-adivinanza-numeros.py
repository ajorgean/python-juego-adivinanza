    ...
    while not adivinado:
        ...
        if adivinanza.isdigit():
            ...
            if adivinanza < numero_secreto:
                ...
                print(f"¡Felicitaciones has ganado! El número {adivinanza} es el sevreto y los has logrado en {intentos} intentos.")
